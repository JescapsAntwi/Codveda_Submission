...
mse = mean_squared_error(y_test_house, y_pred_house) #this number should be as low as possible
rmse = np.sqrt(mse) #more accurate
...
print(f"   - Confusion Matrix:\n{conf_matrix}") #shows how many times the model confused one category for another (a matrix)
...
#Backpropagation (Backward Pass like trial and error)-> sending errors backward through the network
